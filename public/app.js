...
// --- State Management ---
const state = {
    user: JSON.parse(localStorage.getItem('zyra_user')),
    token: localStorage.getItem('zyra_token'),
    cart: [],
    categories: [],
    currentView: 'home',
    params: {}
...
async function renderHome() {
    ...
    container.innerHTML = `
        <section class="hero">
            <div class="hero-bg" style="background-image: url('https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?q=80&w=2087')"></div>
            <div class="hero-content">
                <h1 class="hero-title animate-fade-up">Glow your Way</h1>
                <p style="margin-bottom: 30px; letter-spacing: 2px;" class="animate-fade-up">BELLEZA PREMIUM & CUIDADO</p>
                <div style="display: flex; gap: 20px; justify-content: center;" class="animate-fade-up">
                    <a href="#/catalogo?categoria=1" class="btn-premium">Ver Rostro</a>
                    <a href="#/catalogo?categoria=3" class="btn-premium">Ver Labiales</a>
                </div>
            </div>
        </section>
